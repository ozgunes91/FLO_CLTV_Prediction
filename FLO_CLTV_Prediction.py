...
# GÖREV 1: Veriyi Hazırlama
           # 1. flo_data_20K.csv verisini okuyunuz.Dataframe’in kopyasını oluşturunuz.
            df_ = pd.read_csv('/Users/ozgegunes/Desktop/FLO_CLTV_Prediction/data/flo_data_20k.csv')
...
def create_cltv_pred(dataframe, month=6):
    ...
    return cltv
create_cltv_pred(df).head()

top_5_cutoff = cltv["cltv"].quantile(0.95)
top_customers = cltv[cltv["cltv"] > top_5_cutoff]
print(f"Top 5% müşterilerin ortalama CLTV değeri: {top_customers['cltv'].mean():.2f}")
